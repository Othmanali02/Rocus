...
onMounted(() => {
  if (graphContainer.value) {
    ...
    graph.addNode("n1", { x: 0, y: 0, size: 20, label: "Node 1", color: "#E57373" });
    graph.addNode("n2", { x: -5, y: 5, size: 20, label: "Node 2", color: "#81C784" });
    graph.addNode("n3", { x: 5, y: 5, size: 20, label: "Node 3", color: "#64B5F6" });
    graph.addNode("n4", { x: 0, y: 20, size: 20, label: "Node 4", color: "#FFD54F" });
    graph.addNode("n5", { x: -5, y: 15, size: 20, label: "Node 5", color: "#9575CD" });
    graph.addNode("n6", { x: 5, y: 15, size: 20, label: "Node 6", color: "#4DB6AC" });
